...
public class EuropeActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId())  {
                case R.id.flags:
                    Intent intentFlag = new Intent(getApplicationContext(), EuropeFlagActivity.class);
                    intentFlag.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                    startActivity(intentFlag);
                    break;
                case R.id.currency:
                    Intent intentCurrency = new Intent(getApplicationContext(), EuropeCurrencyActivity.class);
                    intentCurrency.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                    startActivity(intentCurrency);
                    break;
                case R.id.attractions:
                    Intent intentAttractions = new Intent(getApplicationContext(), EuropeAttractionsActivity.class);
